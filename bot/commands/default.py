...
def get_default_commands(lang: str = 'en') -> list[BotCommand]:
    commands = [
        ...
        BotCommand('/incomes', _('посмотреть свои Поступления', locale=lang)),
        BotCommand('/bid', _('создать заявку на бюджет', locale=lang)),
        BotCommand('/bids', _('посмотреть все заявки на бюджет', locale=lang)),
        BotCommand('/mybids', _('посмотреть свои заявки на бюджет', locale=lang)),
        BotCommand('/expense', _('создать новую трату', locale=lang)),
        BotCommand('/expenses', _('Посмотеть свои траты', locale=lang)),
